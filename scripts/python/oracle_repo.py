...
#         consensus_score = calculate_consensus_score(responses, num_step)
...
def calculate_consensus_score(responses, num_step):
    """
    ...
    responses = [list(json.loads(response[num_step]['message']).values())[0] for response in responses]
